    ...
    <div style={{ backgroundColor: projects.bgColor, color: projects.textColor }} className={``}>
      ...
      <div className="mx-auto max-w-screen-xl px-4 md:px-8 py-10">
        ...
        <div className="mb-10 md:mb-16">
          <h2 className={`mb-4 text-center text-2xl font-bold  md:mb-6 lg:text-5xl`}>{projects.title}</h2>
        ...
        <div className="grid gap-8 sm:grid-cols-2 sm:gap-12 lg:grid-cols-3 xl:grid-cols-4 xl:gap-16">
          {projects.items.map((project) => (
            <div key={project.id} className="flex flex-col items-center gap-4 md:flex-row lg:gap-6">
              ...
              <a href={project.link} className="group relative block h-56 shrink-0 self-start overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-24 md:w-24 lg:h-40 lg:w-40">
                <img
