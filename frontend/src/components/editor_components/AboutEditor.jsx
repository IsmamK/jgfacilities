  ...
  return (
    <div className='flex gap-20 items-center justify-between p-20'>
      ...
      <div className='flex flex-col gap-10'>
        <button className="btn btn-primary" onClick={() => setAbout1Open(true)}>Company Profile</button>
        <button className="btn btn-primary" onClick={() => setMessageOpen(true)}>Message</button>
        <button className="btn btn-primary" onClick={() => setAbout2Open(true)}>Mission, Vision and Story</button>
